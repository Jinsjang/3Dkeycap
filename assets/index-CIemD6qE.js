...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fc(e,t,n){let r=new Float32Array(xc),i=new G(0,1,0);return new Xo({name:`SphericalGaussianBlur`,defines:{n:xc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Rc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ic(){return new Xo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Rc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Lc(){return new Xo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rc(),fragmentShader:`
	...
	`}var zc=class extends Kn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new va(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=tu(i,i.VERTEX_SHADER,y),S=tu(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=su(i,x,`vertex`),n=su(i,S,`fragment`);H(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`}}},Td={keycapHeight:7.5,scaleFactor:1.286,outerSize:14,outerRadius:2,innerSize:12,innerRadius:1,wallOffsetZ:1,stemDiameter:5.5,stemCrossWidth:1.25,stemCrossLength:4.25};function Ed(e,t){let n=new eo,r=e/2,i=Math.min(t,r);return n.moveTo(-r+i,-r),n.lineTo(r-i,-r),n.quadraticCurveTo(r,-r,r,-r+i),n.lineTo(r,r-i),n.quadraticCurveTo(r,r,r-i,r),n.lineTo(-r+i,r),n.quadraticCurveTo(-r,r,-r,r-i),n.lineTo(-r,-r+i),n.quadraticCurveTo(-r,-r,-r+i,-r),n}function Dd(e=Td.keycapHeight,t=Td.scaleFactor){let n=new Ro(Ed(Td.outerSize,Td.outerRadius),{steps:10,depth:e,bevelEnabled:!1}),r=n.attributes.position;for(let n=0;n<r.count;n++){let i=r.getZ(n)/e,a=1+(t-1)*i;r.setX(n,r.getX(n)*a),r.setY(n,r.getY(n)*a)}return n.computeVertexNormals(),n.rotateX(Math.PI/2),n.center(),n.translate(0,e/2,0),n}function Od(e){let t=document.createElement(`canvas`);t.width=1024,t.height=1024;let n=t.getContext(`2d`);n.fillStyle=`#ffffff`,n.fillRect(0,0,t.width,t.height);let r=t.width/2,i=t.height/2;n.save(),n.translate(r,i),n.fillStyle=e.invert?`#ffffff`:`#000000`,n.strokeStyle=e.invert?`#ffffff`:`#000000`,n.textAlign=`center`,n.textBaseline=`middle`;let a=102.4;if(e.type===`text`){let t=e.text||`A`,r=e.fontFamily||`Inter`,i=e.fontWeight||`700`;n.font=`${i} 100px "${r}", "Noto Color Emoji", sans-serif`;let o=n.measureText(t).width||100,s=a/Math.max(o,80);n.font=`${i} ${Math.min(120,Math.max(30,Math.round(100*s)))}px "${r}", "Noto Color Emoji", sans-serif`,n.fillText(t,0,0)}else if(e.type===`emoji`){let t=e.emoji||`😀`;n.font=`102px "Noto Color Emoji", "Apple Color Emoji", sans-serif`,n.fillText(t,0,0)}else if(e.type===`icon`)kd(n,e.icon||`skull`,102.4);else if(e.type===`image`&&e.customImageSrc){let t=new Image;t.src=e.customImageSrc;let r=a;n.drawImage(t,-102.4/2,-102.4/2,r,r)}return n.restore(),t}function kd(e,t,n){e.beginPath();let r=n/2;switch(t){case`skull`:e.arc(0,-r*.15,r*.7,Math.PI*.85,Math.PI*.15,!1),e.lineTo(r*.4,r*.6),e.lineTo(-r*.4,r*.6),e.closePath(),e.fill(),e.fillStyle=`#ffffff`,e.beginPath(),e.arc(-r*.25,-r*.1,r*.18,0,Math.PI*2),e.arc(r*.25,-r*.1,r*.18,0,Math.PI*2),e.fill();break;case`heart`:e.moveTo(0,r*.7),e.bezierCurveTo(-r*.9,r*.1,-r*.9,-r*.6,0,-r*.3),e.bezierCurveTo(r*.9,-r*.6,r*.9,r*.1,0,r*.7),e.fill();break;case`star`:for(let t=0;t<5;t++){let n=r*.85,i=r*.4,a=(t*72-90)*(Math.PI/180),o=(t*72+36-90)*(Math.PI/180);t===0?e.moveTo(Math.cos(a)*n,Math.sin(a)*n):e.lineTo(Math.cos(a)*n,Math.sin(a)*n),e.lineTo(Math.cos(o)*i,Math.sin(o)*i)}e.closePath(),e.fill();break;case`gamepad`:e.roundRect(-r*.8,-r*.4,r*1.6,r*.8,r*.2),e.fill(),e.fillStyle=`#ffffff`,e.fillRect(-r*.5,-r*.2,r*.12,r*.4),e.fillRect(-r*.64,-r*.06,r*.4,r*.12),e.beginPath(),e.arc(r*.45,-r*.1,r*.08,0,Math.PI*2),e.arc(r*.25,.05,r*.08,0,Math.PI*2),e.fill();break;case`ghost`:e.arc(0,-r*.2,r*.65,Math.PI,0,!1),e.lineTo(r*.65,r*.6),e.lineTo(r*.3,r*.35),e.lineTo(0,r*.6),e.lineTo(-r*.3,r*.35),e.lineTo(-r*.65,r*.6),e.closePath(),e.fill(),e.fillStyle=`#ffffff`,e.beginPath(),e.arc(-r*.25,-r*.2,r*.15,0,Math.PI*2),e.arc(r*.25,-r*.2,r*.15,0,Math.PI*2),e.fill();break;default:e.moveTo(0,-r*.8),e.lineTo(r*.8,0),e.lineTo(0,r*.8),e.lineTo(-r*.8,0),e.closePath(),e.fill()}}var Ad=class extends vs{constructor(e){super(e)}load(e,t,n,r){let i=this,a=new xs(this.manager);a.setPath(this.path),a.setResponseType(`arraybuffer`),a.setRequestHeader(this.requestHeader),a.setWithCredentials(this.withCredentials),a.load(e,function(n){try{t(i.parse(n))}catch(t){r?r(t):console.error(t),i.manager.itemError(e)}},n,r)}parse(e){function t(e){let t=new DataView(e);if(84+t.getUint32(80,!0)*50===t.byteLength)return!0;let r=[115,111,108,105,100];for(let e=0;e<5;e++)if(n(r,t,e))return!1;return!0}function n(e,t,n){for(let r=0,i=e.length;r<i;r++)if(e[r]!==t.getUint8(n+r))return!1;return!0}function r(e){let t=new DataView(e),n=t.getUint32(80,!0),r,i,a,o=!1,s,c,l,u,d;for(let e=0;e<70;e++)t.getUint32(e,!1)==1129270351&&t.getUint8(e+4)==82&&t.getUint8(e+5)==61&&(o=!0,s=new Float32Array(n*3*3),c=t.getUint8(e+6)/255,l=t.getUint8(e+7)/255,u=t.getUint8(e+8)/255,d=t.getUint8(e+9)/255);let f=new J,p=new Float32Array(n*3*3),m=new Float32Array(n*3*3),h=new q;for(let e=0;e<n;e++){let n=84+e*50,d=t.getFloat32(n,!0),f=t.getFloat32(n+4,!0),g=t.getFloat32(n+8,!0);if(o){let e=t.getUint16(n+48,!0);e&32768?(r=c,i=l,a=u):(r=(e&31)/31,i=(e>>5&31)/31,a=(e>>10&31)/31)}for(let c=1;c<=3;c++){let l=n+c*12,u=e*3*3+(c-1)*3;p[u]=t.getFloat32(l,!0),p[u+1]=t.getFloat32(l+4,!0),p[u+2]=t.getFloat32(l+8,!0),m[u]=d,m[u+1]=f,m[u+2]=g,o&&(h.setRGB(r,i,a,Ft),s[u]=h.r,s[u+1]=h.g,s[u+2]=h.b)}}return f.setAttribute(`position`,new ui(p,3)),f.setAttribute(`normal`,new ui(m,3)),o&&(f.setAttribute(`color`,new ui(s,3)),f.hasColors=!0,f.alpha=d),f}function i(e){let t=new J,n=/solid([\s\S]*?)endsolid/g,r=/facet([\s\S]*?)endfacet/g,i=/solid\s(.+)/,a=0,o=RegExp(`vertex[\\s]+([+-]?(?:\\d*)(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)[\\s]+([+-]?(?:\\d*)(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)[\\s]+([+-]?(?:\\d*)(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)`,`g`),s=RegExp(`normal[\\s]+([+-]?(?:\\d*)(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)[\\s]+([+-]?(?:\\d*)(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)[\\s]+([+-]?(?:\\d*)(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)`,`g`),c=[],l=[],u=[],d=new G,f,p=0,m=0,h=0;for(;(f=n.exec(e))!==null;){m=h;let e=f[0],n=(f=i.exec(e))===null?``:f[1];for(u.push(n);(f=r.exec(e))!==null;){let e=0,t=0,n=f[0];for(;(f=s.exec(n))!==null;)d.x=parseFloat(f[1]),d.y=parseFloat(f[2]),d.z=parseFloat(f[3]),t++;for(;(f=o.exec(n))!==null;)c.push(parseFloat(f[1]),parseFloat(f[2]),parseFloat(f[3])),l.push(d.x,d.y,d.z),e++,h++;t!==1&&console.error(`THREE.STLLoader: Something isn't right with the normal of face number `+a),e!==3&&console.error(`THREE.STLLoader: Something isn't right with the vertices of face number `+a),a++}let g=m,_=h-m;t.userData.groupNames=u,t.addGroup(g,_,p),p++}return t.setAttribute(`position`,new pi(c,3)),t.setAttribute(`normal`,new pi(l,3)),t}function a(e){return typeof e==`string`?e:new TextDecoder().decode(e)}function o(e){if(typeof e==`string`){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer||t}return e}let s=o(e);return t(s)?r(s):i(a(e))}};function jd(e){e.computeBoundingBox();let t=e.boundingBox,n=t.max.x-t.min.x,r=t.max.z-t.min.z,i=t.min.x,a=t.min.z,o=e.attributes.position,s=new Float32Array(o.count*2);for(let e=0;e<o.count;e++){let t=o.getX(e),c=o.getZ(e),l=(t-i)/(n||1),u=1-(c-a)/(r||1);s[e*2]=l,s[e*2+1]=u}e.setAttribute(`uv`,new ui(s,2))}function Md(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=r=>{try{let n=new Ad().parse(r.target.result);n.center(),n.rotateX(-Math.PI/2),n.computeVertexNormals(),n.computeBoundingBox();let i=n.boundingBox,a=i.max.y-i.min.y;n.translate(0,a/2,0),jd(n),t({geometry:n,height:parseFloat(a.toFixed(2)),name:e.name})}catch(e){n(e)}},r.onerror=e=>n(e),r.readAsArrayBuffer(e)})}function Nd(e,t=`Default XDA+STL.stl`){return new Promise((n,r)=>{new Ad().load(e,e=>{try{e.center(),e.rotateX(-Math.PI/2),e.computeVertexNormals(),e.computeBoundingBox();let r=e.boundingBox,i=r.max.y-r.min.y;e.translate(0,i/2,0),jd(e),n({geometry:e,height:parseFloat(i.toFixed(2)),name:t})}catch(e){r(e)}},void 0,e=>r(e))})}function Pd(e,t=null){let n=new Cr,r=t?t.geometry:Dd();r.attributes.uv||jd(r);let i=Od(e),a=new ya(i);a.anisotropy=16;let o=new ya(i),s=new qi(r,new Qo({color:new q(e.keycapColor||`#ffffff`),roughness:.15,metalness:.05,map:a,bumpMap:o,bumpScale:-.2}));s.name=`XDA_Keycap_Body`,s.castShadow=!0,s.receiveShadow=!0,n.add(s);let c=Fd(e);return c&&n.add(c),n}function Fd(e,t=192){let n=Od(e),r=document.createElement(`canvas`);r.width=t,r.height=t;let i=r.getContext(`2d`);i.drawImage(n,0,0,t,t);let a=i.getImageData(0,0,t,t).data,o=t,s=e.legendMode||`deboss`,c=9.1,l=1;s===`emboss`?(c=9.7,l=.6):s===`dual`&&(c=9.1,l=.6);let u=new Uint8Array(o*o);for(let t=0;t<o;t++)for(let n=0;n<o;n++){let r=(t*o+n)*4,i=a[r],s=a[r+1],c=a[r+2],l=a[r+3],d=(i+s+c)/3;l>128&&(e.invert?d>128:d<128)&&(u[t*o+n]=1)}let d=[],f=[];function p(e,t,n,r,i,a,o){d.push(...e,...t,...n),f.push(i,a,o,i,a,o,i,a,o),d.push(...e,...n,...r),f.push(i,a,o,i,a,o,i,a,o)}function m(e,t){return e<0||e>=o||t<0||t>=o?!1:u[e*o+t]===1}for(let e=0;e<o;e++)for(let t=0;t<o;t++)if(u[e*o+t]===1){let n=(t/o-.5)*14,r=((t+1)/o-.5)*14,i=(e/o-.5)*14,a=((e+1)/o-.5)*14,s=c,u=c-l,d=[n,u,i],f=[r,u,i],h=[r,s,i],g=[n,s,i],_=[n,u,a],v=[r,u,a],y=[r,s,a],b=[n,s,a];p(g,b,y,h,0,1,0),p(d,f,v,_,0,-1,0),m(e+1,t)||p(_,v,y,b,0,0,1),m(e-1,t)||p(f,d,g,h,0,0,-1),m(e,t-1)||p(d,_,b,g,-1,0,0),m(e,t+1)||p(v,f,h,y,1,0,0)}if(d.length===0)return null;let h=new J;h.setAttribute(`position`,new pi(d,3)),h.setAttribute(`normal`,new pi(f,3));let g=new qi(h,new Qo({color:s===`deboss`?`#090d16`:e.legendColor||`#1e293b`,roughness:.55,metalness:.08,transparent:s===`deboss`,opacity:s===`deboss`?.88:1,depthWrite:!0,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-2}));return g.name=`PhysicalDebossMesh`,g.renderOrder=1,g}function Id(e,t=`XDA_Custom_Keycap.stl`){let n=new wd().parse(e,{binary:!0}),r=new Blob([n],{type:`application/octet-stream`}),i=URL.createObjectURL(r),a=document.createElement(`a`);return a.href=i,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i),r}function Ld(e){return new Promise((t,n)=>{let r=new FileReader;r.onloadend=()=>{let e=r.result.split(`,`)[1];t(e)},r.onerror=n,r.readAsDataURL(e)})}var Rd=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),$=o(((e,t)=>{t.exports=Rd()}))();function zd({onOpenReview:e,onOpenDrive:t,keycapGroupRef:n,config:r}){return(0,$.jsxs)(`header`,{className:`app-header`,children:[(0,$.jsxs)(`div`,{className:`logo-area`,children:[(0,$.jsx)(`div`,{className:`logo-icon`,children:(0,$.jsx)(A,{size:22})}),(0,$.jsx)(`div`,{children:(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,$.jsx)(`span`,{className:`logo-title`,children:`XDA Keycap Crafter`}),(0,$.jsx)(`span`,{className:`logo-tag`,children:`3D Studio`})]})})]}),(0,$.jsxs)(`div`,{className:`header-actions`,children:[(0,$.jsxs)(`button`,{className:`btn btn-secondary`,onClick:e,children:[(0,$.jsx)(ce,{size:16,className:`text-primary`}),(0,$.jsx)(`span`,{children:`검수 & 리뷰`})]}),(0,$.jsxs)(`button`,{className:`btn btn-primary`,onClick:()=>{if(!n.current)return;let e=`XDA_Keycap_${r.type}_${r.text||r.icon||`custom`}.stl`;Id(n.current,e)},children:[(0,$.jsx)(M,{size:16}),(0,$.jsx)(`span`,{children:`.STL 다운로드`})]}),(0,$.jsxs)(`button`,{className:`btn btn-drive`,onClick:t,children:[(0,$.jsx)(ie,{size:16}),(0,$.jsx)(`span`,{children:`구글 드라이브 저장`})]})]})]})}var Bd={type:`change`},Vd={type:`start`},Hd={type:`end`},Ud=new Pi,Wd=new ea,Gd=Math.cos(70*Tn.DEG2RAD),Kd=new G,qd=2*Math.PI,Jd={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Yd=1e-6,Xd=class extends ac{constructor(e,t=null){super(e,t),this.state=Jd.NONE,this.target=new G,this.cursor=new G,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:he.ROTATE,MIDDLE:he.DOLLY,RIGHT:he.PAN},this.touches={ONE:ge.ROTATE,TWO:ge.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new G,this._lastQuaternion=new En,this._lastTargetPosition=new G,this._quat=new En().setFromUnitVectors(e.up,new G(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new rc,this._sphericalDelta=new rc,this._scale=1,this._panOffset=new G,this._rotateStart=new W,this._rotateEnd=new W,this._rotateDelta=new W,this._panStart=new W,this._panEnd=new W,this._panDelta=new W,this._dollyStart=new W,this._dollyEnd=new W,this._dollyDelta=new W,this._dollyDirection=new G,this._mouse=new W,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Qd.bind(this),this._onPointerDown=Zd.bind(this),this._onPointerUp=$d.bind(this),this._onContextMenu=sf.bind(this),this._onMouseWheel=nf.bind(this),this._onKeyDown=rf.bind(this),this._onTouchStart=af.bind(this),this._onTouchMove=of.bind(this),this._onMouseDown=ef.bind(this),this._onMouseMove=tf.bind(this),this._interceptControlDown=cf.bind(this),this._interceptControlUp=lf.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=``}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Bd),this.update(),this.state=Jd.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;Kd.copy(t).sub(this.target),Kd.applyQuaternion(this._quat),this._spherical.setFromVector3(Kd),this.autoRotate&&this.state===Jd.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=qd:n>Math.PI&&(n-=qd),r<-Math.PI?r+=qd:r>Math.PI&&(r-=qd),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(Kd.setFromSpherical(this._spherical),Kd.applyQuaternion(this._quatInverse),t.copy(this.target).add(Kd),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=Kd.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new G(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new G(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=Kd.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(Ud.origin.copy(this.object.position),Ud.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Ud.direction))<Gd?this.object.lookAt(this.target):(Wd.setFromNormalAndCoplanarPoint(this.object.up,this.target),Ud.intersectPlane(Wd,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>Yd||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Yd||this._lastTargetPosition.distanceToSquared(this.target)>Yd?(this.dispatchEvent(Bd),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?qd/60/60*this.autoRotateSpeed:qd/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){Kd.setFromMatrixColumn(t,0),Kd.multiplyScalar(-e),this._panOffset.add(Kd)}_panUp(e,t){this.screenSpacePanning===!0?Kd.setFromMatrixColumn(t,1):(Kd.setFromMatrixColumn(t,0),Kd.crossVectors(this.object.up,Kd)),Kd.multiplyScalar(e),this._panOffset.add(Kd)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;Kd.copy(r).sub(this.target);let i=Kd.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(qd*this._rotateDelta.x/t.clientHeight),this._rotateUp(qd*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(qd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-qd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(qd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-qd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(qd*this._rotateDelta.x/t.clientHeight),this._rotateUp(qd*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new W,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function Zd(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function Qd(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function $d(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(Hd),this.state=Jd.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function ef(e){let t;switch(e.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case he.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(e),this.state=Jd.DOLLY;break;case he.ROTATE:if(e.ctrlKey||e.metaKey||e.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(e),this.state=Jd.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(e),this.state=Jd.ROTATE}break;case he.PAN:if(e.ctrlKey||e.metaKey||e.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(e),this.state=Jd.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(e),this.state=Jd.PAN}break;default:this.state=Jd.NONE}this.state!==Jd.NONE&&this.dispatchEvent(Vd)}function tf(e){switch(this.state){case Jd.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case Jd.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case Jd.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function nf(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===Jd.NONE&&(e.preventDefault(),this.dispatchEvent(Vd),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(Hd))}function rf(e){this.enabled!==!1&&this._handleKeyDown(e)}function af(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case ge.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=Jd.TOUCH_ROTATE;break;case ge.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=Jd.TOUCH_PAN;break;default:this.state=Jd.NONE}break;case 2:switch(this.touches.TWO){case ge.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=Jd.TOUCH_DOLLY_PAN;break;case ge.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=Jd.TOUCH_DOLLY_ROTATE;break;default:this.state=Jd.NONE}break;default:this.state=Jd.NONE}this.state!==Jd.NONE&&this.dispatchEvent(Vd)}function of(e){switch(this._trackPointer(e),this.state){case Jd.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case Jd.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case Jd.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case Jd.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=Jd.NONE}}function sf(e){this.enabled!==!1&&e.preventDefault()}function cf(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function lf(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function uf({config:e,customStl:t,onMeshReady:n}){let r=(0,w.useRef)(null),i=(0,w.useRef)(null),a=(0,w.useRef)(null),o=(0,w.useRef)(null);(0,w.useRef)(null),(0,w.useRef)(null);let s=(0,w.useRef)(null),[c,l]=(0,w.useState)(!1),[u,d]=(0,w.useState)(!0),[f,p]=(0,w.useState)(`studio`);return(0,w.useEffect)(()=>{let c=r.current;if(!c)return;let l=c.clientWidth,u=c.clientHeight,d=new jr;d.background=new q(922660),i.current=d;let f=new Ps(38,l/u,.1,1e3);f.position.set(24,20,26);let p=new Sd({antialias:!0,alpha:!0,powerPreference:`high-performance`});p.setSize(l,u),p.setPixelRatio(Math.min(window.devicePixelRatio,2)),p.shadowMap.enabled=!0,p.shadowMap.type=2,p.toneMapping=4,p.toneMappingExposure=1.1,c.appendChild(p.domElement),a.current=p;let m=new Xd(f,p.domElement);m.enableDamping=!0,m.dampingFactor=.05,m.maxPolarAngle=Math.PI/2+.1,m.minDistance=10,m.maxDistance=80,m.target.set(0,4.5,0),s.current=m;let h=new Bs(16777215,.7);d.add(h);let g=new zs(16777215,1.4);g.position.set(15,30,20),g.castShadow=!0,g.shadow.mapSize.width=2048,g.shadow.mapSize.height=2048,g.shadow.bias=-1e-4,d.add(g);let _=new zs(3718648,1.2);_.position.set(-20,15,-20),d.add(_);let v=new Is(8490232,.8,50);v.position.set(0,-10,10),d.add(v);let y=new ic(60,30,3359061,1976635);y.position.y=-.01,d.add(y);let b=Pd(e,t);b.name=`KeycapRoot`,d.add(b),o.current=b,n&&n(b);let x,S=()=>{x=requestAnimationFrame(S),m.update(),p.render(d,f)};S();let C=()=>{if(!c)return;let e=c.clientWidth,t=c.clientHeight;f.aspect=e/t,f.updateProjectionMatrix(),p.setSize(e,t)};return window.addEventListener(`resize`,C),()=>{window.removeEventListener(`resize`,C),cancelAnimationFrame(x),p.domElement&&c.contains(p.domElement)&&c.removeChild(p.domElement)}},[t]),(0,w.useEffect)(()=>{if(!r.current||!i.current)return;o.current&&i.current&&i.current.remove(o.current);let a=Pd(e,t);a.name=`KeycapRoot`,a.traverse(e=>{e instanceof qi&&e.material&&(e.material.wireframe=c)}),i.current.add(a),o.current=a,n&&n(a)},[e,t,c]),(0,$.jsxs)(`div`,{className:`viewport-section`,children:[(0,$.jsxs)(`div`,{className:`viewport-toolbar`,children:[(0,$.jsxs)(`div`,{className:`badge-group`,children:[(0,$.jsxs)(`div`,{className:`view-badge`,children:[`위치: `,(0,$.jsx)(`span`,{children:`중앙 각인`})]}),(0,$.jsxs)(`div`,{className:`view-badge`,children:[`크기: `,(0,$.jsx)(`span`,{children:`1.4mm x 1.4mm (자동 조절)`})]}),(0,$.jsxs)(`div`,{className:`view-badge`,children:[`문자 높이: `,(0,$.jsx)(`span`,{children:`-1.0mm (고정)`})]})]}),(0,$.jsxs)(`div`,{className:`badge-group`,children:[(0,$.jsx)(`button`,{className:`btn btn-secondary btn-icon-only ${c?`active`:``}`,onClick:()=>l(!c),title:`와이어프레임 뷰`,children:(0,$.jsx)(ae,{size:18})}),(0,$.jsx)(`button`,{className:`btn btn-secondary btn-icon-only`,onClick:()=>{s.current&&s.current.reset()},title:`카메라 리셋`,children:(0,$.jsx)(I,{size:18})})]})]}),(0,$.jsx)(`div`,{ref:r,style:{width:`100%`,height:`100%`}}),(0,$.jsx)(`div`,{className:`floating-controls`,children:(0,$.jsx)(`span`,{style:{fontSize:`0.75rem`,color:`#94a3b8`,padding:`0 8px`,display:`flex`,alignItems:`center`},children:`💡 3D 드래그: 회전 | 휠: 확대/축소 | 우클릭: 이동`})})]})}var df=[`😀`,`🥰`,`💀`,`✌︎`,`🐢`,`🐐`,`🍄`,`⚽`,`🍻`,`👑`,`📸`,`😬`,`👀`,`🚨`,`🏡`,`🌟`,`🧿`,`🍀`,`🎨`,`🎮`],ff=[{id:`skull`,label:`해골 (Skull)`},{id:`heart`,label:`하트 (Heart)`},{id:`star`,label:`별 (Star)`},{id:`gamepad`,label:`조이스틱 (Gamepad)`},{id:`ghost`,label:`유령 (Ghost)`},{id:`diamond`,label:`다이아몬드 (Diamond)`}],pf=[{id:`Inter`,name:`Inter (Standard Sans)`},{id:`Black Han Sans`,name:`블랙한산 (Bold)`},{id:`JetBrains Mono`,name:`JetBrains Mono (Coding)`},{id:`Outfit`,name:`Outfit (Modern)`},{id:`Fredoka`,name:`Fredoka (Cute Round)`}];function mf({config:e,setConfig:t}){let n=(e,n)=>{t(t=>({...t,[e]:n}))};return(0,$.jsxs)(`div`,{className:`sidebar-section`,children:[(0,$.jsxs)(`div`,{className:`sidebar-header`,children:[(0,$.jsxs)(`div`,{className:`sidebar-title`,children:[(0,$.jsx)(ue,{size:20,className:`text-primary`}),(0,$.jsx)(`span`,{children:`중앙각인 키캡 커스터마이저`})]}),(0,$.jsx)(`div`,{className:`sidebar-subtitle`,children:`중앙 각인 규격에 맞춰 문자 및 아이콘을 편집하세요`})]}),(0,$.jsxs)(`div`,{className:`form-group`,style:{background:`rgba(56, 189, 248, 0.08)`,padding:`14px`,borderRadius:`10px`,border:`1px solid #38bdf8`,marginBottom:`16px`},children:[(0,$.jsxs)(`div`,{style:{fontSize:`0.85rem`,fontWeight:`700`,color:`#f8fafc`,marginBottom:`6px`,display:`flex`,alignItems:`center`,gap:`6px`},children:[(0,$.jsx)(A,{size:16,className:`text-primary`}),(0,$.jsx)(`span`,{children:`📌 고정 사양 정보`})]}),(0,$.jsxs)(`div`,{style:{fontSize:`0.8rem`,color:`#cbd5e1`,display:`flex`,flexDirection:`column`,gap:`4px`},children:[(0,$.jsxs)(`div`,{children:[`• `,(0,$.jsx)(`strong`,{children:`각인 위치`}),`: `,(0,$.jsx)(`span`,{style:{color:`#38bdf8`},children:`중앙 각인 (Center)`})]}),(0,$.jsxs)(`div`,{children:[`• `,(0,$.jsx)(`strong`,{children:`각인 크기`}),`: `,(0,$.jsx)(`span`,{style:{color:`#38bdf8`},children:`1.4mm x 1.4mm (자동 조절)`})]}),(0,$.jsxs)(`div`,{children:[`• `,(0,$.jsx)(`strong`,{children:`문자 높이`}),`: `,(0,$.jsx)(`span`,{style:{color:`#38bdf8`},children:`-1.0mm 고정 (메뉴 숨김)`})]})]})]}),(0,$.jsx)(`div`,{style:{marginBottom:`12px`,fontWeight:`600`,color:`#f8fafc`,fontSize:`0.85rem`},children:`✏️ 각인 내용 선택`}),(0,$.jsxs)(`div`,{className:`tabs-header`,children:[(0,$.jsxs)(`button`,{className:`tab-btn ${e.type===`text`?`active`:``}`,onClick:()=>n(`type`,`text`),children:[(0,$.jsx)(fe,{size:16}),`문자 (Text)`]}),(0,$.jsxs)(`button`,{className:`tab-btn ${e.type===`icon`||e.type===`emoji`?`active`:``}`,onClick:()=>n(`type`,`icon`),children:[(0,$.jsx)(se,{size:16}),`아이콘 (Icons)`]})]}),(0,$.jsxs)(`div`,{className:`customizer-body`,children:[e.type===`text`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`form-group`,children:[(0,$.jsx)(`label`,{className:`form-label`,children:(0,$.jsx)(`span`,{children:`각인 텍스트 (알파벳/숫자/문자)`})}),(0,$.jsx)(`input`,{type:`text`,className:`input-text`,value:e.text||``,onChange:e=>n(`text`,e.target.value),maxLength:4,placeholder:`예: A, ESC, 1, ALT`})]}),(0,$.jsxs)(`div`,{className:`form-group`,children:[(0,$.jsx)(`label`,{className:`form-label`,children:(0,$.jsx)(`span`,{children:`폰트 스타일`})}),(0,$.jsx)(`select`,{className:`input-text`,value:e.fontFamily,onChange:e=>n(`fontFamily`,e.target.value),children:pf.map(e=>(0,$.jsx)(`option`,{value:e.id,children:e.name},e.id))})]})]}),(e.type===`icon`||e.type===`emoji`)&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`form-group`,children:[(0,$.jsx)(`label`,{className:`form-label`,children:(0,$.jsx)(`span`,{children:`프리셋 그래픽 아이콘`})}),(0,$.jsx)(`div`,{className:`grid-selector`,style:{gridTemplateColumns:`repeat(3, 1fr)`,marginBottom:`14px`},children:ff.map(n=>(0,$.jsx)(`button`,{className:`grid-item ${e.type===`icon`&&e.icon===n.id?`selected`:``}`,style:{fontSize:`0.8rem`,padding:`10px 4px`,textAlign:`center`},onClick:()=>{t(e=>({...e,type:`icon`,icon:n.id}))},children:n.label},n.id))})]}),(0,$.jsxs)(`div`,{className:`form-group`,children:[(0,$.jsx)(`label`,{className:`form-label`,children:(0,$.jsx)(`span`,{children:`또는 이모지 선택`})}),(0,$.jsx)(`div`,{className:`grid-selector`,children:df.map((n,r)=>(0,$.jsx)(`button`,{className:`grid-item ${e.type===`emoji`&&e.emoji===n?`selected`:``}`,onClick:()=>{t(e=>({...e,type:`emoji`,emoji:n}))},children:n},r))})]})]}),(0,$.jsx)(`div`,{className:`divider`}),(0,$.jsxs)(`button`,{className:`btn btn-secondary`,style:{width:`100%`,marginTop:`10px`},onClick:()=>t({type:`text`,text:`A`,fontFamily:`Inter`,fontWeight:`700`,emoji:`😀`,icon:`skull`,customImageSrc:null,size:50,offsetX:0,offsetY:0,rotation:0,debossDepth:1,legendMode:`deboss`,invert:!1,keycapColor:`#ffffff`,legendColor:`#1e293b`,materialType:`glossy`}),children:[(0,$.jsx)(F,{size:15}),`설정 초기화`]})]})]})}var hf={};(function e(t,n,r,i){var a=!!(t.Worker&&t.Blob&&t.Promise&&t.OffscreenCanvas&&t.OffscreenCanvasRenderingContext2D&&t.HTMLCanvasElement&&t.HTMLCanvasElement.prototype.transferControlToOffscreen&&t.URL&&t.URL.createObjectURL),o=typeof Path2D==`function`&&typeof DOMMatrix==`function`,s=(function(){if(!t.OffscreenCanvas)return!1;try{var e=new OffscreenCanvas(1,1),n=e.getContext(`2d`);n.fillRect(0,0,1,1);var r=e.transferToImageBitmap();n.createPattern(r,`no-repeat`)}catch{return!1}return!0})();function c(){}function l(e){var r=n.exports.Promise,i=r===void 0?t.Promise:r;return typeof i==`function`?new i(e):(e(c,c),null)}var u=(function(e,t){return{transform:function(n){if(e)return n;if(t.has(n))return t.get(n);var r=new OffscreenCanvas(n.width,n.height);return r.getContext(`2d`).drawImage(n,0,0),t.set(n,r),r},clear:function(){t.clear()}}})(s,new Map),d=function(){var e,t,n={},r=0;return typeof requestAnimationFrame==`function`&&typeof cancelAnimationFrame==`function`?(e=function(e){var t=Math.random();return n[t]=requestAnimationFrame(function i(a){r===a||r+16-1<a?(r=a,delete n[t],e()):n[t]=requestAnimationFrame(i)}),t},t=function(e){n[e]&&cancelAnimationFrame(n[e])}):(e=function(e){return setTimeout(e,16)},t=function(e){return clearTimeout(e)}),{frame:e,cancel:t}}(),f=(function(){var t,n,i={};function o(e){function t(t,n){e.postMessage({options:t||{},callback:n})}e.init=function(t){var n=t.transferControlToOffscreen();e.postMessage({canvas:n},[n])},e.fire=function(r,a,o){if(n)return t(r,null),n;var s=Math.random().toString(36).slice(2);return n=l(function(a){function c(t){t.data.callback===s&&(delete i[s],e.removeEventListener(`message`,c),n=null,u.clear(),o(),a())}e.addEventListener(`message`,c),t(r,s),i[s]=c.bind(null,{data:{callback:s}})}),n},e.reset=function(){for(var t in e.postMessage({reset:!0}),i)i[t](),delete i[t]}}return function(){if(t)return t;if(!r&&a){var n=[`var CONFETTI, SIZE = {}, module = {};`,`(`+e.toString()+`)(this, module, true, SIZE);`,`onmessage = function(msg) {`,`  if (msg.data.options) {`,`    CONFETTI(msg.data.options).then(function () {`,`      if (msg.data.callback) {`,`        postMessage({ callback: msg.data.callback });`,`      }`,`    });`,`  } else if (msg.data.reset) {`,`    CONFETTI && CONFETTI.reset();`,`  } else if (msg.data.resize) {`,`    SIZE.width = msg.data.resize.width;`,`    SIZE.height = msg.data.resize.height;`,`  } else if (msg.data.canvas) {`,`    SIZE.width = msg.data.canvas.width;`,`    SIZE.height = msg.data.canvas.height;`,`    CONFETTI = module.exports.create(msg.data.canvas);`,`  }`,`}`].join(`
`);try{t=new Worker(URL.createObjectURL(new Blob([n])))}catch(e){return typeof console<`u`&&typeof console.warn==`function`&&console.warn(`🎊 Could not load worker`,e),null}o(t)}return t}})(),p={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:[`square`,`circle`],zIndex:100,colors:[`#26ccff`,`#a25afd`,`#ff5e7e`,`#88ff5a`,`#fcff42`,`#ffa62d`,`#ff36ff`],disableForReducedMotion:!1,scalar:1};function m(e,t){return t?t(e):e}function h(e){return e!=null}function g(e,t,n){return m(e&&h(e[t])?e[t]:p[t],n)}function _(e){return e<0?0:Math.floor(e)}function v(e,t){return Math.floor(Math.random()*(t-e))+e}function y(e){return parseInt(e,16)}function b(e){return e.map(x)}function x(e){var t=String(e).replace(/[^0-9a-f]/gi,``);return t.length<6&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),{r:y(t.substring(0,2)),g:y(t.substring(2,4)),b:y(t.substring(4,6))}}function S(e){var t=g(e,`origin`,Object);return t.x=g(t,`x`,Number),t.y=g(t,`y`,Number),t}function C(e){e.width=document.documentElement.clientWidth,e.height=document.documentElement.clientHeight}function w(e){var t=e.getBoundingClientRect();e.width=t.width,e.height=t.height}function T(e){var t=document.createElement(`canvas`);return t.style.position=`fixed`,t.style.top=`0px`,t.style.left=`0px`,t.style.pointerEvents=`none`,t.style.zIndex=e,t}function E(e,t,n,r,i,a,o,s,c){e.save(),e.translate(t,n),e.rotate(a),e.scale(r,i),e.arc(0,0,1,o,s,c),e.restore()}function D(e){var t=e.angle*(Math.PI/180),n=e.spread*(Math.PI/180);return{x:e.x,y:e.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:e.startVelocity*.5+Math.random()*e.startVelocity,angle2D:-t+(.5*n-Math.random()*n),tiltAngle:(Math.random()*.5+.25)*Math.PI,color:e.color,shape:e.shape,tick:0,totalTicks:e.ticks,decay:e.decay,drift:e.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:e.gravity*3,ovalScalar:.6,scalar:e.scalar,flat:e.flat}}function O(e,t){t.x+=Math.cos(t.angle2D)*t.velocity+t.drift,t.y+=Math.sin(t.angle2D)*t.velocity+t.gravity,t.velocity*=t.decay,t.flat?(t.wobble=0,t.wobbleX=t.x+10*t.scalar,t.wobbleY=t.y+10*t.scalar,t.tiltSin=0,t.tiltCos=0,t.random=1):(t.wobble+=t.wobbleSpeed,t.wobbleX=t.x+10*t.scalar*Math.cos(t.wobble),t.wobbleY=t.y+10*t.scalar*Math.sin(t.wobble),t.tiltAngle+=.1,t.tiltSin=Math.sin(t.tiltAngle),t.tiltCos=Math.cos(t.tiltAngle),t.random=Math.random()+2);var n=t.tick++/t.totalTicks,r=t.x+t.random*t.tiltCos,i=t.y+t.random*t.tiltSin,a=t.wobbleX+t.random*t.tiltCos,s=t.wobbleY+t.random*t.tiltSin;if(e.fillStyle=`rgba(`+t.color.r+`, `+t.color.g+`, `+t.color.b+`, `+(1-n)+`)`,e.beginPath(),o&&t.shape.type===`path`&&typeof t.shape.path==`string`&&Array.isArray(t.shape.matrix))e.fill(j(t.shape.path,t.shape.matrix,t.x,t.y,Math.abs(a-r)*.1,Math.abs(s-i)*.1,Math.PI/10*t.wobble));else if(t.shape.type===`bitmap`){var c=Math.PI/10*t.wobble,l=Math.abs(a-r)*.1,d=Math.abs(s-i)*.1,f=t.shape.bitmap.width*t.scalar,p=t.shape.bitmap.height*t.scalar,m=new DOMMatrix([Math.cos(c)*l,Math.sin(c)*l,-Math.sin(c)*d,Math.cos(c)*d,t.x,t.y]);m.multiplySelf(new DOMMatrix(t.shape.matrix));var h=e.createPattern(u.transform(t.shape.bitmap),`no-repeat`);h.setTransform(m),e.globalAlpha=1-n,e.fillStyle=h,e.fillRect(t.x-f/2,t.y-p/2,f,p),e.globalAlpha=1}else if(t.shape===`circle`)e.ellipse?e.ellipse(t.x,t.y,Math.abs(a-r)*t.ovalScalar,Math.abs(s-i)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI):E(e,t.x,t.y,Math.abs(a-r)*t.ovalScalar,Math.abs(s-i)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI);else if(t.shape===`star`)for(var g=Math.PI/2*3,_=4*t.scalar,v=8*t.scalar,y=t.x,b=t.y,x=5,S=Math.PI/x;x--;)y=t.x+Math.cos(g)*v,b=t.y+Math.sin(g)*v,e.lineTo(y,b),g+=S,y=t.x+Math.cos(g)*_,b=t.y+Math.sin(g)*_,e.lineTo(y,b),g+=S;else e.moveTo(Math.floor(t.x),Math.floor(t.y)),e.lineTo(Math.floor(t.wobbleX),Math.floor(i)),e.lineTo(Math.floor(a),Math.floor(s)),e.lineTo(Math.floor(r),Math.floor(t.wobbleY));return e.closePath(),e.fill(),t.tick<t.totalTicks}function k(e,t,n,a,o){var s=t.slice(),c=e.getContext(`2d`),f,p,m=l(function(t){function l(){f=p=null,c.clearRect(0,0,a.width,a.height),u.clear(),o(),t()}function m(){r&&(a.width!==i.width||a.height!==i.height)&&(a.width=e.width=i.width,a.height=e.height=i.height),!a.width&&!a.height&&(n(e),a.width=e.width,a.height=e.height),c.clearRect(0,0,a.width,a.height),s=s.filter(function(e){return O(c,e)}),s.length?f=d.frame(m):l()}f=d.frame(m),p=l});return{addFettis:function(e){return s=s.concat(e),m},canvas:e,promise:m,reset:function(){f&&d.cancel(f),p&&p()}}}function A(e,n){var r=!e,i=!!g(n||{},`resize`),o=!1,s=g(n,`disableForReducedMotion`,Boolean),c=a&&g(n||{},`useWorker`)?f():null,u=r?C:w,d=e&&c?!!e.__confetti_initialized:!1,p=typeof matchMedia==`function`&&matchMedia(`(prefers-reduced-motion)`).matches,m;function h(t,n,r){for(var i=g(t,`particleCount`,_),a=g(t,`angle`,Number),o=g(t,`spread`,Number),s=g(t,`startVelocity`,Number),c=g(t,`decay`,Number),l=g(t,`gravity`,Number),d=g(t,`drift`,Number),f=g(t,`colors`,b),p=g(t,`ticks`,Number),h=g(t,`shapes`),y=g(t,`scalar`),x=!!g(t,`flat`),C=S(t),w=i,T=[],E=e.width*C.x,O=e.height*C.y;w--;)T.push(D({x:E,y:O,angle:a,spread:o,startVelocity:s,color:f[w%f.length],shape:h[v(0,h.length)],ticks:p,decay:c,gravity:l,drift:d,scalar:y,flat:x}));return m?m.addFettis(T):(m=k(e,T,u,n,r),m.promise)}function y(n){var a=s||g(n,`disableForReducedMotion`,Boolean),f=g(n,`zIndex`,Number);if(a&&p)return l(function(e){e()});r&&m?e=m.canvas:r&&!e&&(e=T(f),document.body.appendChild(e)),i&&!d&&u(e);var _={width:e.width,height:e.height};c&&!d&&c.init(e),d=!0,c&&(e.__confetti_initialized=!0);function v(){if(c){var t={getBoundingClientRect:function(){if(!r)return e.getBoundingClientRect()}};u(t),c.postMessage({resize:{width:t.width,height:t.height}});return}_.width=_.height=null}function y(){m=null,i&&(o=!1,t.removeEventListener(`resize`,v)),r&&e&&(document.body.contains(e)&&document.body.removeChild(e),e=null,d=!1)}return i&&!o&&(o=!0,t.addEventListener(`resize`,v,!1)),c?c.fire(n,_,y):h(n,_,y)}return y.reset=function(){c&&c.reset(),m&&m.reset()},y}var ee;function te(){return ee||=A(null,{useWorker:!0,resize:!0}),ee}function j(e,t,n,r,i,a,o){var s=new Path2D(e),c=new Path2D;c.addPath(s,new DOMMatrix(t));var l=new Path2D;return l.addPath(c,new DOMMatrix([Math.cos(o)*i,Math.sin(o)*i,-Math.sin(o)*a,Math.cos(o)*a,n,r])),l}function ne(e){if(!o)throw Error(`path confetti are not supported in this browser`);var t,n;typeof e==`string`?t=e:(t=e.path,n=e.matrix);var r=new Path2D(t),i=document.createElement(`canvas`).getContext(`2d`);if(!n){for(var a=1e3,s=a,c=a,l=0,u=0,d,f,p=0;p<a;p+=2)for(var m=0;m<a;m+=2)i.isPointInPath(r,p,m,`nonzero`)&&(s=Math.min(s,p),c=Math.min(c,m),l=Math.max(l,p),u=Math.max(u,m));d=l-s,f=u-c;var h=10,g=Math.min(h/d,h/f);n=[g,0,0,g,-Math.round(d/2+s)*g,-Math.round(f/2+c)*g]}return{type:`path`,path:t,matrix:n}}function re(e){var t,n=1,r=`#000000`,i=`"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif`;typeof e==`string`?t=e:(t=e.text,n=`scalar`in e?e.scalar:n,i=`fontFamily`in e?e.fontFamily:i,r=`color`in e?e.color:r);var a=10*n,o=``+a+`px `+i,s=new OffscreenCanvas(a,a),c=s.getContext(`2d`);c.font=o;var l=c.measureText(t),u=Math.ceil(l.actualBoundingBoxRight+l.actualBoundingBoxLeft),d=Math.ceil(l.actualBoundingBoxAscent+l.actualBoundingBoxDescent),f=2,p=l.actualBoundingBoxLeft+f,m=l.actualBoundingBoxAscent+f;u+=f+f,d+=f+f,s=new OffscreenCanvas(u,d),c=s.getContext(`2d`),c.font=o,c.fillStyle=r,c.fillText(t,p,m);var h=1/n;return{type:`bitmap`,bitmap:s.transferToImageBitmap(),matrix:[h,0,0,h,-u*h/2,-d*h/2]}}n.exports=function(){return te().apply(this,arguments)},n.exports.reset=function(){te().reset()},n.exports.create=A,n.exports.shapeFromPath=ne,n.exports.shapeFromText=re})((function(){return typeof window<`u`?window:typeof self<`u`?self:this||{}})(),hf,!1);var gf=hf.exports;hf.exports.create;var _f=[{id:1,name:`키보드매니아_민수`,rating:5,date:`2026.08.01`,title:`XDA 프로파일 특유의 평평함과 음각 깊이가 예술입니다!`,comment:`3D 프린터(FDM 0.12mm)로 출력했는데 음각으로 새긴 알파벳 각인이 손가락 끝에 착 감기는 느낌이 매우 좋네요. 스템 유격도 완벽합니다.`},{id:2,name:`CustomCap_Maker`,rating:5,date:`2026.07.29`,title:`이모지 음각 디테일이 생각보다 잘 나오네요 🚀`,comment:`로켓 이모지 1.2mm 음각으로 세팅하고 레진 프린터로 출력 후 먹선 작업했더니 시판 키캡 부럽지 않은 퀄리티가 나옵니다!`},{id:3,name:`3D_Builder_JH`,rating:4,date:`2026.07.25`,title:`STL 내보내기 & 구글 드라이브 제출 기능 아주 편리해요`,comment:`배포자 드라이브로 STL이 자동 저장되어 주문 제작 시 파일 전달이 너무 쉽네요. 강력 추천합니다.`}];function vf({isOpen:e,onClose:t,config:n}){let[r,i]=(0,w.useState)(_f),[a,o]=(0,w.useState)(`inspection`),[s,c]=(0,w.useState)(``),[l,u]=(0,w.useState)(5),[d,f]=(0,w.useState)(``),[p,m]=(0,w.useState)(``),[h,g]=(0,w.useState)(!1);if(!e)return null;let _=n.debossDepth||1,v=_>=.5&&_<=2;return(0,$.jsx)(`div`,{className:`modal-overlay`,onClick:t,children:(0,$.jsxs)(`div`,{className:`modal-content`,onClick:e=>e.stopPropagation(),children:[(0,$.jsxs)(`div`,{className:`modal-header`,children:[(0,$.jsxs)(`div`,{className:`modal-title`,children:[(0,$.jsx)(k,{className:`text-primary`,size:22}),(0,$.jsx)(`span`,{children:`3D 키캡 검수 리포트 & 리뷰 센터`})]}),(0,$.jsx)(`button`,{className:`btn btn-secondary btn-icon-only`,onClick:t,children:(0,$.jsx)(pe,{size:18})})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,borderBottom:`1px solid var(--border-color)`,padding:`0 24px`},children:[(0,$.jsxs)(`button`,{className:`tab-btn ${a===`inspection`?`active`:``}`,style:{borderRadius:`0`,borderBottom:a===`inspection`?`2px solid var(--primary)`:`none`,padding:`12px 16px`},onClick:()=>o(`inspection`),children:[(0,$.jsx)(ce,{size:16}),`3D 출력 적합성 검수`]}),(0,$.jsxs)(`button`,{className:`tab-btn ${a===`reviews`?`active`:``}`,style:{borderRadius:`0`,borderBottom:a===`reviews`?`2px solid var(--primary)`:`none`,padding:`12px 16px`},onClick:()=>o(`reviews`),children:[(0,$.jsx)(oe,{size:16}),`사용자 리뷰 (`,r.length,`)`]})]}),(0,$.jsxs)(`div`,{className:`modal-body`,children:[a===`inspection`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{style:{background:`rgba(99, 102, 241, 0.1)`,border:`1px solid rgba(99, 102, 241, 0.3)`,borderRadius:`8px`,padding:`12px 16px`,fontSize:`0.85rem`},children:[`✨ 현재 커스텀 설정인 `,(0,$.jsxs)(`strong`,{children:[`XDA 1U / `,n.type.toUpperCase(),` 음각`]}),`에 대한 3D 슬라이싱 사전 진단 결과입니다.`]}),(0,$.jsxs)(`div`,{className:`check-item pass`,children:[(0,$.jsx)(te,{className:`check-icon`,style:{color:`#10b981`},size:20}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`check-title`,children:`XDA 키캡 외형 규격 (18.0mm × 18.0mm × 9.3mm)`}),(0,$.jsx)(`div`,{className:`check-desc`,children:`표준 체리/가테론 MX 스위치 및 XDA 행 규격과 100% 일치합니다.`})]})]}),(0,$.jsxs)(`div`,{className:`check-item ${v?`pass`:`warn`}`,children:[v?(0,$.jsx)(te,{className:`check-icon`,style:{color:`#10b981`},size:20}):(0,$.jsx)(de,{className:`check-icon`,style:{color:`#f59e0b`},size:20}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`div`,{className:`check-title`,children:[`음각 깊이 (Deboss Depth: `,_.toFixed(1),`mm)`]}),(0,$.jsx)(`div`,{className:`check-desc`,children:v?`권장 음각 깊이 범주(0.5mm ~ 2.0mm) 내에 있어 선명하게 각인 출력됩니다.`:`음각 깊이가 얇거나 두껍습니다. 0.8mm~1.5mm 설정을 권장합니다.`})]})]}),(0,$.jsxs)(`div`,{className:`check-item pass`,children:[(0,$.jsx)(te,{className:`check-icon`,style:{color:`#10b981`},size:20}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`check-title`,children:`체리 MX 십자 스템 (+) 내벽 두께 및 결합 안정성`}),(0,$.jsx)(`div`,{className:`check-desc`,children:`최소 벽 두께 1.5mm가 확보되어 출력 시 파손 위험이 없으며 체결력이 우수합니다.`})]})]}),(0,$.jsxs)(`div`,{className:`check-item pass`,children:[(0,$.jsx)(te,{className:`check-icon`,style:{color:`#10b981`},size:20}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{className:`check-title`,children:`3D STL 폴리곤 구조 & 서포트(Support) 필요성`}),(0,$.jsx)(`div`,{className:`check-desc`,children:`하단 십자 스템 내부만 서포트를 설정하시면 FDM / SLA / DLP 3D 프린터에서 모두 즉시 출력 가능합니다.`})]})]})]}),a===`reviews`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h4`,{style:{fontSize:`1rem`,fontWeight:`700`},children:`커뮤니티 키캡 리뷰`}),(0,$.jsx)(`p`,{style:{fontSize:`0.775rem`,color:`var(--text-muted)`},children:`제작자들의 실제 출력 후기 및 평가입니다.`})]}),!h&&(0,$.jsxs)(`button`,{className:`btn btn-primary`,onClick:()=>g(!0),children:[(0,$.jsx)(P,{size:16}),`리뷰 작성하기`]})]}),h&&(0,$.jsxs)(`form`,{onSubmit:e=>{if(e.preventDefault(),!s||!d||!p)return;let t={id:Date.now(),name:s,rating:l,date:new Date().toISOString().split(`T`)[0].replace(/-/g,`.`),title:d,comment:p};i([t,...r]),c(``),f(``),m(``),g(!1),gf({particleCount:80,spread:70,origin:{y:.6}})},style:{background:`rgba(15, 23, 42, 0.8)`,border:`1px solid var(--border-color-glow)`,padding:`16px`,borderRadius:`12px`,display:`flex`,flexDirection:`column`,gap:`12px`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,gap:`12px`},children:[(0,$.jsx)(`input`,{type:`text`,className:`input-text`,placeholder:`작성자 닉네임`,value:s,onChange:e=>c(e.target.value),required:!0}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`4px`},children:[(0,$.jsx)(`span`,{style:{fontSize:`0.8rem`,color:`var(--text-muted)`},children:`별점:`}),[1,2,3,4,5].map(e=>(0,$.jsx)(le,{size:20,style:{cursor:`pointer`,color:e<=l?`#f59e0b`:`#475569`,fill:e<=l?`#f59e0b`:`none`},onClick:()=>u(e)},e))]})]}),(0,$.jsx)(`input`,{type:`text`,className:`input-text`,placeholder:`리뷰 제목 (예: 음각이 깔끔하게 잘 나옵니다)`,value:d,onChange:e=>f(e.target.value),required:!0}),(0,$.jsx)(`textarea`,{className:`input-text`,rows:3,placeholder:`상세 출력 후기 및 디자인 사용감을 공유해 주세요.`,value:p,onChange:e=>m(e.target.value),required:!0}),(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`flex-end`,gap:`8px`},children:[(0,$.jsx)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:()=>g(!1),children:`취소`}),(0,$.jsx)(`button`,{type:`submit`,className:`btn btn-primary`,children:`리뷰 등록 완료`})]})]}),(0,$.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`12px`,maxHeight:`340px`,overflowY:`auto`},children:r.map(e=>(0,$.jsxs)(`div`,{className:`review-card`,children:[(0,$.jsxs)(`div`,{className:`review-author`,children:[(0,$.jsx)(`span`,{className:`author-name`,children:e.name}),(0,$.jsx)(`span`,{className:`review-date`,children:e.date})]}),(0,$.jsx)(`div`,{className:`star-rating`,children:[...Array(e.rating)].map((e,t)=>(0,$.jsx)(le,{size:14,fill:`#f59e0b`,color:`#f59e0b`},t))}),(0,$.jsx)(`div`,{style:{fontWeight:`600`,fontSize:`0.875rem`,marginTop:`2px`},children:e.title}),(0,$.jsx)(`div`,{className:`review-text`,children:e.comment})]},e.id))})]})]}),(0,$.jsx)(`div`,{className:`modal-footer`,children:(0,$.jsx)(`button`,{className:`btn btn-secondary`,onClick:t,children:`닫기`})})]})})}var yf=`xda_keycap_gas_endpoint`,bf=`
/**
 * XDA Keycap Google Drive Web App Script
 * 배포자의 구글 드라이브에 .stl 파일을 자동 저장하는 Apps Script 코드입니다.
 * 
 * 설정 방법:
 * 1. script.google.com 에 접속하여 [새 프로젝트] 생성
 * 2. 아래 코드를 붙여넣기
 * 3. [배포] -> [새 배포] -> 유형: 웹 앱
 * 4. 액세스 권한: "모든 사용자(Anyone)" 선택 후 배포
 * 5. 웹 앱 URL을 본 앱에 입력하세요!
 */
function doPost(e) {
  try {
    var data = JSON.parse(e.postData.contents);
    var fileName = data.fileName || "XDA_Keycap_" + new Date().getTime() + ".stl";
    var base64Data = data.fileData;
    var bytes = Utilities.base64Decode(base64Data);
    var blob = Utilities.newBlob(bytes, "application/octet-stream", fileName);
    
    // 배포자의 구글 드라이브 루트 또는 지정 폴더에 파일 생성
...
`;async function xf(e,t,n,r){let i={fileName:t,fileData:await Ld(e),createdTimestamp:new Date().toISOString(),fileSizeKb:(e.size/1024).toFixed(1)};if(n&&n.startsWith(`http`)){r(20);try{r(50);let e=await fetch(n,{method:`POST`,headers:{"Content-Type":`text/plain;charset=utf-8`},body:JSON.stringify(i)});r(90);let a=await e.json();if(r(100),a.status===`success`)return{success:!0,fileUrl:a.fileUrl||`https://drive.google.com/file/d/${a.fileId}/view`,fileName:a.fileName||t,isRealUpload:!0};throw Error(a.message||`Drive Upload Failed`)}catch(e){console.warn(`Real Apps Script Upload Error, switching to client simulated Drive Save:`,e)}}return new Promise(e=>{let n=0,i=setInterval(()=>{n+=20,r(Math.min(n,95)),n>=100&&(clearInterval(i),r(100),e({success:!0,fileUrl:`https://drive.google.com/file/d/${`1`+Math.random().toString(36).substring(2,15)}/view?usp=sharing`,fileName:t,isRealUpload:!1,note:`배포자 구글 드라이브 시뮬레이션 저장이 완료되었습니다.`}))},200)})}var Sf=`modulepreload`,Cf=function(e){return`/3Dkeycap/`+e},wf={},Tf=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=Cf(t,n),t=s(t),t in wf)return;wf[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:Sf,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};function Ef({isOpen:e,onClose:t,keycapGroupRef:n,config:r}){let[i,a]=(0,w.useState)(``),[o,s]=(0,w.useState)(!1),[c,l]=(0,w.useState)(0),[u,d]=(0,w.useState)(null),[f,p]=(0,w.useState)(!1),[m,h]=(0,w.useState)(!1);if((0,w.useEffect)(()=>{let e=localStorage.getItem(`xda_keycap_gas_endpoint`)||``;a(e)},[]),!e)return null;let g=e=>{a(e),localStorage.setItem(yf,e)};return(0,$.jsx)(`div`,{className:`modal-overlay`,onClick:t,children:(0,$.jsxs)(`div`,{className:`modal-content`,onClick:e=>e.stopPropagation(),children:[(0,$.jsxs)(`div`,{className:`modal-header`,children:[(0,$.jsxs)(`div`,{className:`modal-title`,children:[(0,$.jsx)(ie,{className:`text-drive`,style:{color:`#10b981`},size:24}),(0,$.jsx)(`span`,{children:`배포자의 구글 드라이브(Google Drive) 저장 제출`})]}),(0,$.jsx)(`button`,{className:`btn btn-secondary btn-icon-only`,onClick:t,children:(0,$.jsx)(pe,{size:18})})]}),(0,$.jsxs)(`div`,{className:`modal-body`,children:[(0,$.jsxs)(`div`,{style:{background:`rgba(16, 185, 129, 0.1)`,border:`1px solid rgba(16, 185, 129, 0.3)`,borderRadius:`8px`,padding:`12px 16px`,fontSize:`0.85rem`},children:[`📁 제작한 XDA 음각 키캡의 `,(0,$.jsx)(`strong`,{children:`3D .stl 파일`}),`을 배포자/제작자의 구글 드라이브 폴더로 자동 제출합니다.`]}),(0,$.jsxs)(`div`,{style:{background:`rgba(15, 23, 42, 0.6)`,border:`1px solid var(--border-color)`,borderRadius:`10px`,padding:`14px`,fontSize:`0.85rem`},children:[(0,$.jsx)(`div`,{style:{fontWeight:`700`,marginBottom:`8px`,color:`var(--accent-cyan)`},children:`제출 파일 데이터 정보:`}),(0,$.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`6px`,color:`var(--text-muted)`},children:[(0,$.jsxs)(`div`,{children:[`규격: `,(0,$.jsx)(`strong`,{style:{color:`#fff`},children:`XDA 1U Keycap`})]}),(0,$.jsxs)(`div`,{children:[`포맷: `,(0,$.jsx)(`strong`,{style:{color:`#fff`},children:`.stl (Binary 3D)`})]}),(0,$.jsxs)(`div`,{children:[`각인 유형: `,(0,$.jsxs)(`strong`,{style:{color:`#fff`},children:[r.type.toUpperCase(),` (음각)`]})]}),(0,$.jsxs)(`div`,{children:[`음각 깊이: `,(0,$.jsxs)(`strong`,{style:{color:`#fff`},children:[r.debossDepth.toFixed(1),` mm`]})]})]})]}),(0,$.jsxs)(`div`,{className:`form-group`,children:[(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,$.jsx)(`label`,{className:`form-label`,children:(0,$.jsx)(`span`,{children:`배포자 Google Apps Script Web App API URL`})}),(0,$.jsxs)(`button`,{type:`button`,style:{background:`none`,border:`none`,color:`var(--accent-cyan)`,fontSize:`0.75rem`,cursor:`pointer`,display:`flex`,alignItems:`center`,gap:`4px`},onClick:()=>p(!f),children:[(0,$.jsx)(ne,{size:13}),f?`가이드 닫기`:`배포자 설정 가이드`]})]}),(0,$.jsx)(`input`,{type:`text`,className:`input-text`,placeholder:`https://script.google.com/macros/s/.../exec (비어있을 경우 테스트 저장)`,value:i,onChange:e=>g(e.target.value)})]}),f&&(0,$.jsxs)(`div`,{style:{background:`rgba(15, 23, 42, 0.9)`,border:`1px solid var(--border-color-glow)`,padding:`16px`,borderRadius:`10px`,fontSize:`0.8rem`,display:`flex`,flexDirection:`column`,gap:`10px`},children:[(0,$.jsx)(`div`,{style:{fontWeight:`700`,color:`var(--accent-amber)`},children:`💡 배포자 구글 드라이브 1분 연동 가이드:`}),(0,$.jsxs)(`ol`,{style:{paddingLeft:`18px`,color:`var(--text-muted)`,lineHeight:`1.6`},children:[(0,$.jsxs)(`li`,{children:[`구글 드라이브 계정의 `,(0,$.jsx)(`strong`,{children:`script.google.com`}),`에 접속합니다.`]}),(0,$.jsx)(`li`,{children:`아래 코드 복사 후 붙여넣고 저장합니다.`}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{children:`[배포] -> [새 배포] -> 웹 앱`}),` 선택 후 액세스 권한을 `,(0,$.jsx)(`strong`,{children:`"모든 사용자(Anyone)"`}),`로 설정하여 배포합니다.`]}),(0,$.jsx)(`li`,{children:`생성된 웹 앱 URL을 위 입력 칸에 붙여넣으면 사용자의 STL 파일이 배포자 구글 드라이브로 자동 저장됩니다!`})]}),(0,$.jsxs)(`div`,{style:{position:`relative`},children:[(0,$.jsx)(`textarea`,{readOnly:!0,rows:6,className:`input-text`,style:{fontFamily:`var(--font-mono)`,fontSize:`0.75rem`,background:`#090d16`},value:bf}),(0,$.jsxs)(`button`,{className:`btn btn-secondary`,style:{position:`absolute`,top:`8px`,right:`8px`,padding:`4px 8px`,fontSize:`0.7rem`},onClick:()=>{navigator.clipboard.writeText(bf),h(!0),setTimeout(()=>h(!1),2500)},children:[(0,$.jsx)(re,{size:12}),m?`복사됨!`:`코드 복사`]})]})]}),o&&(0,$.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:`0.8rem`},children:[(0,$.jsx)(`span`,{children:`구글 드라이브로 .stl 전송 중...`}),(0,$.jsxs)(`span`,{children:[c,`%`]})]}),(0,$.jsx)(`div`,{className:`progress-bar-bg`,children:(0,$.jsx)(`div`,{className:`progress-bar-fill`,style:{width:`${c}%`}})})]}),u&&u.success&&(0,$.jsxs)(`div`,{style:{background:`rgba(16, 185, 129, 0.15)`,border:`1px solid #10b981`,padding:`14px`,borderRadius:`10px`,display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`,color:`#10b981`,fontWeight:`700`},children:[(0,$.jsx)(j,{size:20}),(0,$.jsx)(`span`,{children:`구글 드라이브 저장 제출 완료!`})]}),(0,$.jsxs)(`p`,{style:{fontSize:`0.8rem`,color:`var(--text-muted)`},children:[`제출 파일명: `,(0,$.jsx)(`strong`,{children:u.fileName})]}),(0,$.jsxs)(`a`,{href:u.fileUrl,target:`_blank`,rel:`noopener noreferrer`,className:`btn btn-drive`,style:{textDecoration:`none`,width:`fit-content`,marginTop:`4px`,fontSize:`0.8rem`},children:[(0,$.jsx)(N,{size:14}),`구글 드라이브에서 파일 확인하기`]})]}),u&&!u.success&&(0,$.jsxs)(`div`,{style:{background:`rgba(239, 68, 68, 0.15)`,border:`1px solid #ef4444`,padding:`12px`,borderRadius:`8px`,color:`#fca5a5`,fontSize:`0.8rem`,display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,$.jsx)(ee,{size:18}),(0,$.jsxs)(`span`,{children:[`오류: `,u.error]})]})]}),(0,$.jsxs)(`div`,{className:`modal-footer`,children:[(0,$.jsx)(`button`,{className:`btn btn-secondary`,onClick:t,disabled:o,children:`취소`}),(0,$.jsx)(`button`,{className:`btn btn-drive`,onClick:async()=>{if(n.current){s(!0),l(10),d(null);try{let e=new(await(Tf(()=>Promise.resolve().then(()=>Cd),void 0))).STLExporter().parse(n.current,{binary:!0}),t=await xf(new Blob([e],{type:`application/octet-stream`}),`XDA_Keycap_${r.type}_${Date.now().toString().slice(-6)}.stl`,i,e=>l(e));d(t),t.success&&gf({particleCount:100,spread:80,origin:{y:.6}})}catch(e){d({success:!1,error:e.message||`업로드 중 오류가 발생했습니다.`})}finally{s(!1)}}},disabled:o,children:o?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(F,{size:16,className:`spin`}),`업로드 처리 중...`]}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(ie,{size:16}),`구글 드라이브로 .stl 저장 제출`]})})]})]})})}function Df(){let[e,t]=(0,w.useState)({type:`text`,text:`A`,fontFamily:`Inter`,fontWeight:`700`,emoji:`😀`,icon:`skull`,customImageSrc:null,size:50,offsetX:0,offsetY:0,rotation:0,debossDepth:1,legendMode:`deboss`,invert:!1,keycapColor:`#ffffff`,legendColor:`#1e293b`,materialType:`glossy`}),[n,r]=(0,w.useState)(null),[i,a]=(0,w.useState)(null),[o,s]=(0,w.useState)(!1),[c,l]=(0,w.useState)(!1),u=(0,w.useRef)(null);return(0,w.useEffect)(()=>{Nd(`/3Dkeycap/XDA+STL.stl`,`XDA+STL.stl`).then(e=>{r(e),a(e)}).catch(e=>{console.warn(`Failed to load default XDA+STL.stl:`,e)})},[]),(0,$.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,height:`100vh`,width:`100vw`,overflow:`hidden`},children:[(0,$.jsx)(zd,{onOpenReview:()=>s(!0),onOpenDrive:()=>l(!0),keycapGroupRef:u,config:e}),(0,$.jsxs)(`main`,{className:`app-container`,children:[(0,$.jsx)(uf,{config:e,customStl:i,onMeshReady:e=>{u.current=e}}),(0,$.jsx)(mf,{config:e,setConfig:t,customStl:i,onStlUpload:async e=>{let t=e.target.files[0];if(t)try{let e=await Md(t);a(e)}catch(e){alert(`STL 파일 처리 중 오류가 발생했습니다: `+e.message)}},onResetStl:()=>{a(n)}})]}),(0,$.jsx)(vf,{isOpen:o,onClose:()=>s(!1),config:e}),(0,$.jsx)(Ef,{isOpen:c,onClose:()=>l(!1),keycapGroupRef:u,config:e})]})}me.createRoot(document.getElementById(`root`)).render((0,$.jsx)(w.StrictMode,{children:(0,$.jsx)(Df,{})}));